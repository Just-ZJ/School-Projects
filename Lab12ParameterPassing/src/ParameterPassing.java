...
public final class ParameterPassing {
    ...
    /**
     * Additional Activity: Test parameter passing for array type.
     *
     * @param a
    ...
    /**
     * Additional Activity: Test swapping for array type.
     *
     * @param a1
     *            the first parameter of array type
     * @param a2
    ...
    public static void main(String[] args) {
        ...
        final int a = 43210;
        final int b = 24601;
        num1 = new NaturalNumber2(a);
        num2 = new NaturalNumber2(b);
